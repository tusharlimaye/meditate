...
switch(Number(window.localStorage["ratecount1"])){
    case 0: case 0.5:
        $("#st1").html("N/A");
        $("#img1").attr("src","../img/head1-200.png");
        break;
    case 1: case 1.5:
        $("#st1").html("ROUGH");
...
switch(Number(window.localStorage["ratecount2"])){
    case 0: case 0.5:
        $("#st2").html("N/A");
        $("#img2").attr("src","../img/head1-200.png");
        break;
    case 1: case 1.5:
        $("#st2").html("ROUGH");
...
switch(Number(window.localStorage["ratecount3"])){
    case 0: case 0.5:
        $("#st3").html("N/A");
        $("#img3").attr("src","../img/head1-200.png");
        break;
    case 1: case 1.5:
        $("#st3").html("ROUGH");
...
switch(Number(window.localStorage["ratecount4"])){
    case 0: case 0.5:
        $("#st4").html("N/A");
        $("#img4").attr("src","../img/head1-200.png");
        break;
    case 1: case 1.5:
        $("#st4").html("ROUGH");
...
switch(Number(window.localStorage["ratecount5"])){
    case 0: case 0.5:
        $("#st5").html("N/A");
        $("#img5").attr("src","../img/head1-200.png");
        break;
    case 1: case 1.5:
        $("#st5").html("ROUGH");
...
switch(Number(window.localStorage["ratecount6"])){
    case 0: case 0.5:
        $("#st6").html("N/A");
        $("#img6").attr("src","../img/head1-200.png");
        break;
    case 1: case 1.5:
        $("#st6").html("ROUGH");
...
switch(Number(window.localStorage["ratecount7"])){
    case 0: case 0.5:
        $("#st7").html("N/A");
        $("#img7").attr("src","../img/head1-200.png");
        break;
    case 1: case 1.5:
        $("#st7").html("ROUGH");
...
/*-----------------------DISPLAY11 (Total Meditation)-----------------------------------*/

switch(Number(window.localStorage["setnum"])){
    case 1:
        $("#totalmedi").html("CANDLE EXCERCISE");
        break;
    case 2:
        $("#totalmedi").html("CONCENTRATION EXERCISE");
        break;
    case 3:
        $("#totalmedi").html("SENSORY PERCEPTION (SIGHT)");
        break;
    case 4:
        $("#totalmedi").html("SENSORY PERCEPTION (SMELL)");
        break;
    case 5:
        $("#totalmedi").html("SENSORY PERCEPTION (SOUND)");
        break;
    case 6:
        $("#totalmedi").html("SENSORY PERCEPTION (TASTE)");
        break;
    case 7:
        $("#totalmedi").html("SENSORY PERCEPTION (TOUCH)");
        break;
    case 8:
        $("#totalmedi").html("MEDITATION EXCERCISE");
        break;
}
